                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        {!! Form::select('nationality', ['Afghan' => 'Afghan', 'Other' => 'Other'], $nationality , ['class' => 'form-control', 'required' => 'true']) !!}
                                        <span class="form-control-feedback"></span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input  type="text" class="form-control" name="nationality_other" @if(!$student || $student->nationality == "Afghan") readonly @endif placeholder="Nationality" value="@if($student && $student->nationality != "Afghan"){{$student->nationality}}@else{{old('nationality')}}@endif" maxlength="50" >
